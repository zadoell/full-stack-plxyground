...
import { LoadingSpinner, ErrorState, NoticeBanner, useToast } from '../../src/components/UIComponents';
...
export default function EditOpportunityScreen() {
  ...
  const fetchOpportunity = async () => {
    try {
      ...
      setFetchError(err.message || 'Failed to load opportunity');
    } finally {
  ...
  if (fetchError) {
    return (
      <View style={styles.container}>
        ...
        <ErrorState
          message={fetchError}
          onRetry={() => { setInitialLoading(true); fetchOpportunity(); }}
        />
      </View>
    );
  }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.form}>
        <Text style={styles.pageTitle}>Edit Opportunity</Text>
        <Text style={styles.pageSubtitle}>Update the details below and resubmit</Text>
